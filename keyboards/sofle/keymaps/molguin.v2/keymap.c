...
//    └──────┴───┼─────┼──────┼──────┼─────┼─────────────────┤   ├──────────────┼─────┼──────┼──────┼─────┼───┴──────┘
//               │ esc │ lalt │ lgui │ spc │ MO(_NAVIGATION) │   │ MO(_SYMBOLS) │ ent │ bspc │ ralt │ del │
//               └─────┴──────┴──────┴─────┴─────────────────┘   └──────────────┴─────┴──────┴──────┴─────┘
[_BASE] = LAYOUT(
  ...
  KC_LSFT  , KC_Z , KC_X   , KC_C    , KC_V    , KC_B     , KC_AUDIO_MUTE   ,     KC_NO        , KC_N     , KC_M    , KC_COMM , KC_DOT , KC_SLSH , KC_RSFT ,
                    KC_ESC , KC_LALT , KC_LGUI , KC_SPACE , MO(_NAVIGATION) ,     MO(_SYMBOLS) , KC_ENTER , KC_BSPC , KC_RALT , KC_DEL
),
...
[_SYMBOLS] = LAYOUT(
  ...
  KC_TRNS , KC_EXCLAIM , KC_AT   , KC_HASH , KC_NO   , KC_NO   ,                       KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO     , KC_NO  ,
  KC_LCTL , KC_CIRC    , KC_LPRN , KC_LBRC , KC_LCBR , KC_LABK ,                       KC_RABK , KC_RCBR , KC_RBRC , KC_RPRN , KC_DOLLAR , KC_NO  ,
