...
//    └─────────────┴───┼───┼──────┼──────┼─────┼─────────────────┤   ├──────────────┼──────┼──────┼───┼─────┼───┴──────┘
//                      │ / │ lalt │ lgui │ spc │ MO(_NAVIGATION) │   │ MO(_SYMBOLS) │ rgui │ ralt │ = │ ent │
//                      └───┴──────┴──────┴─────┴─────────────────┘   └──────────────┴──────┴──────┴───┴─────┘
[_BASE] = LAYOUT(
  ...
  KC_LSFT        , KC_Z , KC_X    , KC_C    , KC_V    , KC_B     , KC_AUDIO_MUTE   ,     KC_NO        , KC_N    , KC_M    , KC_COMM , KC_DOT   , KC_BSLS , KC_RSFT,
                          KC_SLSH , KC_LALT , KC_LGUI , KC_SPACE , MO(_NAVIGATION) ,     MO(_SYMBOLS) , KC_RGUI , KC_RALT , KC_EQL  , KC_ENTER
),
...
[_SYMBOLS] = LAYOUT(
  ...
  KC_LSFT , KC_CIRC , KC_BSLS , KC_SCLN , KC_PIPE , KC_NO    , KC_NO ,     KC_NO   , KC_NO   , KC_LBRC , KC_RBRC , KC_TILDE , KC_DLR  , KC_RSFT,
                      KC_NO   , KC_LALT , KC_LGUI , KC_SPACE , KC_NO ,     KC_TRNS , KC_RGUI , KC_RALT , KC_NO   , KC_NO
),
...
[_NAVIGATION] = LAYOUT(
  ...
  KC_LSFT , KC_NO   , KC_NO           , KC_NO               , KC_NO                 , KC_NO   , KC_NO   ,     KC_NO , KC_NO   , KC_NO   , KC_NO , KC_NO     , KC_NO  , KC_RSFT,
                      KC_NO           , KC_LALT             , KC_LGUI               , KC_NO   , KC_TRNS ,     KC_NO , KC_RGUI , KC_RALT , KC_NO , KC_INSERT
),
