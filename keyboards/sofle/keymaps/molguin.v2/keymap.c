...
//    └──────┴───┼─────┼──────────┼──────┼─────┼──────┤   ├─────────────────┼──────────────┼───┼───┼─────┼───┴──────┘
//               │ esc │ hid_menu │ lalt │ spc │ lgui │   │ MO(_NAVIGATION) │ MO(_SYMBOLS) │ - │ = │ del │
//               └─────┴──────────┴──────┴─────┴──────┘   └─────────────────┴──────────────┴───┴───┴─────┘
[_BASE] = LAYOUT(
  ...
  KC_LSFT  , KC_Z , KC_X   , KC_C    , KC_V    , KC_B     , KC_AUDIO_MUTE ,     KC_NO           , KC_N         , KC_M    , KC_COMM , KC_DOT , KC_SLSH , KC_RSFT,
                    KC_ESC , KC_WWW_SEARCH , KC_LALT , KC_SPACE , KC_LGUI       ,     MO(_NAVIGATION) , MO(_SYMBOLS) , KC_MINS , KC_EQL  , KC_DEL
),
...
[_SYMBOLS] = LAYOUT(
  ...
  KC_LSFT , KC_CIRC , KC_BSLS , KC_SCLN , KC_PIPE , KC_NO    , KC_NO   ,     KC_NO   , KC_NO   , KC_LBRC , KC_RBRC , KC_TILDE  , KC_DLR  , KC_RSFT,
                      KC_NO   , KC_NO   , KC_LALT , KC_ENTER , KC_LGUI ,     KC_TRNS , KC_TRNS , KC_NO   , KC_NO   , KC_INSERT
),
...
[_NAVIGATION] = LAYOUT(
  ...
  KC_LSFT , KC_HOME , KC_NO           , KC_NO               , KC_NO                 , KC_NO   , KC_NO   ,     KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_END   , KC_NO  , KC_RSFT,
                      KC_NO           , KC_NO               , KC_LALT               , KC_NO   , KC_LGUI ,     KC_TRNS , KC_TRNS , KC_RGUI , KC_RALT , KC_NO
),
